...
public class MenuDataMahasiswa {
		...
		do {
			if (menuChoice == 0) {
				...
				do {
					...
					System.out.print("Nomor Induk Mahasiswa (NIM)       : "); nim.replace(0, nim.length(), inScan.next(ptrNoInduk));
